...
Block Diagram could always use more documentation, whether as part of the official Block Diagram docs, in docstrings, or even on the web in blog posts, articles, and such.
